...
All machine learning models are saved in the \texttt{predictors} directory as pickle files.
...
Please refer to the visualization in Appendix Figure~\ref{fig:data_management_plan} for the structure of the project's data management plan. The project's code can be accessed through the following link: \url{https://github.com/didemd/mlclassification_exotoxins}.