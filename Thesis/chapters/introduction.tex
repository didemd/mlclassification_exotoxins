...
(This could be mixed with the introduction for *Advances in the Study of Bacterial Toxins: Their Roles and Mechanisms in Pathogenesis*.)
...
The classification of bacterial exotoxins primarily includes three types, while a fourth type has been discussed but remains to be fully recognized in the scientific literature (citationXXX). These include:
	\begin{itemize}
	...
	\end{itemize}
	Overall toxin biosynthesis can be influenced by a variety of environmental and genetic factors\cite{ohtani2016toxin}. XXX
	
	Therefore, understanding bacterial toxins more thoroughly would be effective in balancing their pathogenic effects with therapeutic applications.
